...
function Projetos(){
    ...
    <div className='centralizado'>
        ...
        <div className='container-projetos'>
                ...
                <h2 className='grid-c2 grid-l1'>Construindo uma plataforma de cursos</h2>
                <video className='grid-c2 grid-l2'  height="380" controls muted loop >
                    <source src="/nlw.mp4" type="video/mp4"/>   
                </video>
                <p className='grid-c2 grid-l3'>Um plataforma de cursos contruida durante o evento "Ignite Lab". A proposta era reunir  Devs e montar uma aplicação completa com ferramentas modernas. 
                <br />
                <a href="https://github.com/Victor-Alves1/Ignite-Lab">Código no Github.</a>
                </p>
                <p className='grid-c2 grid-l4'>Tecnologias utilizadas:<img src="/stack/icons8-html-5.svg" alt="icone html" /> HTML
                            <img src="/stack/icons8-css3.svg" alt="icone css" /> CSS 
